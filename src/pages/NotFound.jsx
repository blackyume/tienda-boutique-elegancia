    ...
    return (
        <div className="h-screen w-full flex items-center justify-center relative overflow-hidden bg-black">
            ...
            <div className="relative z-10 text-center px-6 max-w-2xl">
                <span className="text-[#C19A6B] font-bold tracking-[0.4em] uppercase text-xs mb-4 block animate-fadeIn">Error 404</span>
                ...
                <div className="animate-slideUp delay-200">
                    <Button onClick={() => navigate('/')} className="bg-white text-black hover:bg-[#C19A6B] hover:text-white px-10 py-4 rounded-none font-bold tracking-[0.2em] transform transition-all duration-500 hover:scale-105">
