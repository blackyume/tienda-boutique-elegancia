...
export const Contact = () => {
    ...
    const enviarWhatsapp = () => {
        const texto = `¡Hola! Soy ${nombre || 'un cliente'}.%0A%0A${encodeURIComponent(mensaje || 'Quería hacer una consulta.')}`;
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-slate-50 dark:bg-white/[0.03] border border-slate-100 dark:border-white/10 rounded-2xl p-6">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-xs mb-5">Completá y te abrimos el chat de WhatsApp con tu mensaje listo.</p>
