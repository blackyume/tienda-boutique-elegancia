...
export const About = () => {
    ...
    return (
        <div className="pt-24 pb-0 animate-fadeIn bg-white dark:bg-slate-950 font-sans overflow-x-hidden">
            ...
            {/* VALUES GRID */}
            <div className="bg-slate-50 dark:bg-[#1C1F25] py-24 border-y border-slate-100 dark:border-slate-800">
            ...
            <div className="max-w-7xl mx-auto px-6 py-24">
                <div className="flex flex-col-reverse md:flex-row items-center gap-16">
                    <div className="w-full md:w-1/2 relative">
                        ...
                        />
                        <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-[#1C1F25] p-6 hidden md:flex items-center justify-center text-center border border-white/10 shadow-xl">
