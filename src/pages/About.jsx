...
import { Award, Heart, ShieldCheck, Instagram, MapPin } from 'lucide-react';
        ...
        <div className="pt-24 pb-0 animate-fadeIn bg-white dark:bg-slate-950 font-sans overflow-x-hidden">
            ...
            <div className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center text-white px-4 max-w-4xl">
                    <span className="block text-[#E8C65E] font-bold tracking-[0.3em] uppercase mb-4 animate-slideDown">Nuestra Historia</span>
            ...
            <div className="max-w-7xl mx-auto px-6 py-24">
                <div className="flex flex-col md:flex-row items-center gap-16">
                    <div className="w-full md:w-1/2 space-y-8">
                        <div>
                            <span className="text-[#E8C65E] font-bold tracking-widest uppercase text-xs">La Visión</span>
                        ...
                        <div className="pt-4 flex gap-4">
                            <div className="flex flex-col items-center p-4 bg-slate-50 dark:bg-slate-900 rounded-xl w-32 border border-slate-100 dark:border-slate-800">
                                <span className="text-3xl font-bold text-[#E8C65E] font-cinzel">100%</span>
                                <span className="text-[10px] uppercase text-slate-500 font-bold tracking-wider mt-1 text-center">Hecho en Argentina</span>
                            </div>
                            <div className="flex flex-col items-center p-4 bg-slate-50 dark:bg-slate-900 rounded-xl w-32 border border-slate-100 dark:border-slate-800">
                                <span className="text-3xl font-bold text-[#E8C65E] font-cinzel">País</span>
                    ...
                    <div className="w-full md:w-1/2 relative">
                        <div className="absolute top-10 -right-10 w-full h-full border-2 border-[#E8C65E] rounded-none z-0 hidden md:block"></div>
                        <img
            ...
            {/* VALUES GRID */}
            <div className="bg-slate-50 dark:bg-[#11100D] py-24 border-y border-slate-100 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-[#E8C65E] font-bold tracking-[0.2em] uppercase text-xs mb-2 block">Nuestros Pilares</span>
            ...
            <div className="max-w-7xl mx-auto px-6 py-24">
                <div className="flex flex-col-reverse md:flex-row items-center gap-16">
                    <div className="w-full md:w-1/2 relative">
                        ...
                        />
                        <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-[#11100D] p-6 hidden md:flex items-center justify-center text-center border border-white/10 shadow-xl">
                            <span className="text-[#E8C65E] font-serif italic text-xl">"Cada entrega es un regalo."</span>
                        </div>
                    </div>
                    <div className="w-full md:w-1/2 space-y-8">
                        <div>
                            <span className="text-[#E8C65E] font-bold tracking-widest uppercase text-xs">La Experiencia</span>
                        ...
                        <ul className="space-y-4 pt-4">
                            {[
                                ...
                                <li key={i} className="flex items-center gap-4 text-slate-700 dark:text-slate-300 font-light">
                                    <span className="w-2 h-2 bg-[#E8C65E] rounded-full"></span>
                                    {item}
                                </li>
                            ))}
                        </ul>
            ...
            <div className="max-w-7xl mx-auto px-6 py-24">
                <div className="bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[400px]">
                    <div className="w-full md:w-1/2 bg-[url('https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=2070')] bg-cover bg-center relative">
                        <div className="absolute inset-0 bg-[#E8C65E]/20 mix-blend-multiply"></div>
                    </div>
                    <div className="w-full md:w-1/2 p-12 lg:p-16 flex flex-col justify-center text-white">
                        ...
                        <div className="space-y-4 mb-10">
                            <div className="flex items-center gap-4 text-slate-300">
                                <div className="p-2 bg-white/10 rounded-full"><MapPin className="w-5 h-5 text-[#E8C65E]" /></div>
                            ...
                            <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-slate-300 hover:text-white transition-colors">
                                <div className="p-2 bg-white/10 rounded-full"><Instagram className="w-5 h-5 text-[#E8C65E]" /></div>
                                <span className="font-light">{instagramHandle}</span>
                            </a>
                        </div>

                        <Button onClick={() => navigate('/')} className="bg-[#E8C65E] hover:bg-white hover:text-black text-white px-8 py-4 rounded-none font-bold tracking-[0.2em] w-fit transition-all duration-300">
                            EXPLORAR COLECCIÓN
                        </Button>
                    </div>
                </div>
...
const ValueCard = ({ icon: Icon, title, desc }) => (
    <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 hover:shadow-xl transition-all duration-300 group hover:-translate-y-2">
        <div className="w-14 h-14 bg-[#E8C65E]/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-[#E8C65E] transition-colors duration-300">
            <Icon className="w-7 h-7 text-[#E8C65E] group-hover:text-white transition-colors" />
        </div>
