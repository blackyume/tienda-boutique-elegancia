...
export const Home = () => {
    ...
    return (
        <div className="font-sans bg-[#11100D] text-white overflow-x-hidden">
            <SEO
            ...
            <Suspense fallback={<div className="h-[600px] bg-[#11100D]" />}>
            ...
            <section className="py-14 md:py-20 px-6 bg-[#11100D]">
            ...
            <Suspense fallback={<div className="h-[200px] bg-[#11100D]" />}>
                <CountdownBanner />
            </Suspense>
            ...
            {/* Prueba social */}
            <Suspense fallback={<div className="h-[400px] bg-[#11100D]" />}>
                <Testimonials />
            </Suspense>
