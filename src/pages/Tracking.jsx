...
export const Tracking = () => {
    ...
    return (
        <div className="min-h-screen pt-32 pb-20 bg-slate-50 dark:bg-[#0B1120] font-sans transition-colors duration-500">
                    ...
                    <form onSubmit={handleSearch} className="flex gap-3">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:border-slate-900 dark:focus:border-[#C19A6B] text-slate-900 dark:text-white transition-colors"
                            />
                        </div>
