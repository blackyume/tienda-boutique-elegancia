...
export const ProductSkeleton = () => (
    <div className="flex flex-col">
        <div className="aspect-[4/5] w-full rounded-md animate-pulse bg-gradient-to-br from-slate-100 via-slate-200 to-slate-100 dark:from-slate-800 dark:via-slate-700 dark:to-slate-800" />
