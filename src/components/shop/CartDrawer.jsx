...
export const CartDrawer = ({ isOpen, onClose }) => {
   ...
   return (
      <div className={`fixed inset-0 z-[100] overflow-hidden ${isOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}>
         ...
         {/* Drawer */}
         <div className={`absolute right-0 top-0 h-full w-full max-w-md bg-[#11100D]/95 backdrop-blur-2xl border-l border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] transition-transform duration-500 ease-out-quint flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
