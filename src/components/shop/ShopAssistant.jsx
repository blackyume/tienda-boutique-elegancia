...
export const ShopAssistant = () => {
    ...
    return (
        <div className="fixed bottom-24 sm:bottom-28 right-4 sm:right-6 z-50 flex flex-col items-end pointer-events-none">
            ...
            >
                {!isOpen && (
                    <div className={`absolute right-16 bottom-1 w-max transition-all duration-500 origin-right drop-shadow-lg pointer-events-none ${isHovered ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}>
                        <div className="bg-slate-900/95 backdrop-blur-xl border border-white/10 p-3 rounded-2xl rounded-br-none shadow-2xl">
                            ...
                            <p className="text-[10px] text-slate-300">¡Hola! Estoy aquí para ayudarte a elegir tu look.</p>
                        </div>
                    </div>
                )}
                <button
