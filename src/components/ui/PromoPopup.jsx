                ...
                <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-center md:text-left">
                    ...
                    {code && (
                        <div className="flex flex-col gap-2">
                            <p className="text-xs font-bold uppercase tracking-widest text-[#C19A6B]">Tu código exclusivo</p>
                            <div
                                onClick={copyCode}
                                className="bg-slate-100 dark:bg-slate-800 border-2 border-dashed border-slate-300 dark:border-slate-700 p-4 rounded-xl flex justify-between items-center cursor-pointer hover:border-[#C19A6B] group transition-colors"
                            >
                                <span className="font-mono text-xl font-bold tracking-widest text-slate-800 dark:text-white">{code}</span>
                                <Copy className="w-5 h-5 text-slate-400 group-hover:text-[#C19A6B]" />
                            </div>
