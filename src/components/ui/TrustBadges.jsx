...
export const TrustBadges = ({ className = "" }) => {
    return (
        <div className={`flex flex-wrap justify-center gap-6 md:gap-12 py-8 border-t border-b border-slate-100 dark:border-slate-800 ${className}`}>
            <div className="flex items-center gap-3">
                <div className="h-9 px-3 bg-[#FFF159] rounded-lg flex items-center justify-center shadow-sm border border-[#FFF159]">
                    <svg role="img" viewBox="0 0 24 24" className="h-4 w-auto text-[#009EE3] fill-current" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <h4 className="text-xs font-bold uppercase tracking-wider text-slate-900 dark:text-white">Pago Seguro</h4>
                    <p className="text-[10px] text-slate-500">Procesado por Mercado Pago</p>
                </div>
            </div>
