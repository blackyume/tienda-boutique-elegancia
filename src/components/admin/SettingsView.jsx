                    ...
                    {section === 'notificaciones' && (
                        <>
                            ...
                            <div className={cardCls + ' border-l-4 border-l-blue-500'}>
                                <h3 className="font-bold mb-4 flex items-center gap-2 text-slate-800 dark:text-white"><Mail className="w-5 h-5 text-blue-500" /> EmailJS (recibos)</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <div><label className={labelCls}>Template ID</label><input type="text" defaultValue={siteConfig?.emailjs?.templateId || ''} className={inputCls + ' font-mono'} id="emailjsTemplateId" /></div>
                                        ...
                                        <Button onClick={() => { updateSiteConfig({ emailjs: { serviceId: document.getElementById('emailjsServiceId').value, templateId: document.getElementById('emailjsTemplateId').value, publicKey: document.getElementById('emailjsPublicKey').value } }); addToast('EmailJS guardado', 'success'); }} className="w-full bg-slate-800 text-white text-xs py-3 rounded-lg">Guardar credenciales</Button>
                                    </div>
                    ...
                    {section === 'ia' && (
                        <div className={cardCls + ' border-l-4 border-l-purple-500'}>
                            ...
                            <div className="bg-purple-50 dark:bg-purple-900/10 p-4 rounded-xl border border-purple-100 dark:border-purple-900/30 mb-4">
                                <p className="text-sm text-purple-800 dark:text-purple-300"><strong>Motor:</strong> Cerebras (rápido, para Laurina y copy). <strong>Visión:</strong> Gemini (analiza fotos de prendas). El asistente del cliente usa Gemini.</p>
                            </div>
