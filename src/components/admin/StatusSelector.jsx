                ...
                >
                    {OPTIONS.map(opt => (
                        <button
                            ...
                            className={`w-full text-left px-4 py-2.5 text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-700 flex items-center gap-2 ${currentStatus === opt.value ? 'bg-slate-50 dark:bg-slate-700/50 text-[#E8C65E]' : 'text-slate-500 dark:text-slate-400'}`}
                        >
