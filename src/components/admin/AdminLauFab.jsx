            ...
            {!open && (
                ...
                >
                    <span className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-[0_10px_30px_-8px_rgba(212,175,55,0.65)] overflow-hidden"
                        ...
                        <Sparkles className="relative w-6 h-6 text-[#0A0A0A]" />
                        <span className="absolute -inset-1 rounded-full border border-[#D4AF37]/40 animate-pulse pointer-events-none" />
                    </span>
                    <span className="hidden sm:block bg-[#0A0A0A]/90 backdrop-blur border border-[#D4AF37]/30 text-[#D4AF37] text-[11px] font-bold uppercase tracking-[0.15em] px-3 py-2 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all duration-300">
                        Lau
                    </span>
                </button>
            )}
