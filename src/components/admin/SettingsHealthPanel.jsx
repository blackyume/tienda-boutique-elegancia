...
export const SettingsHealthPanel = ({ onJump }) => {
    ...
    const checks = [
        ...
        { id: 'gma',  ok: Boolean((aiConfig?.adminKeys || '').trim()), label: 'Gemini · Admin (visión primaria)', okHint: 'Análisis de fotos disponible', badHint: 'Sin Gemini ni NVIDIA, Laurina no puede analizar fotos', goto: 'ia' },
