...
// Dorado/plata metálicos (gradiente). Requieren `background` (no backgroundColor).
...
export const COLOR_MAP = {
    'blanco': '#ffffff', 'negro': '#000000', 'gris': '#808080', 'gris claro': '#d3d3d3', 'gris oscuro': '#a9a9a9', 'plata': METALLIC_SILVER, 'plateado': METALLIC_SILVER, 'humo': '#848884', 'carbon': '#36454f', 'blanco tiza': '#f5f5f5', 'hueso': '#e3dac9', 'marfil': '#fffff0', 'crema': '#fffdd0', 'vainilla': '#f3e5ab', 'nude': '#f5d0b5', 'piel': '#f5d0b5', 'natural': '#faebd7', 'champagne': '#fad6a5', 'vison': '#9e9e9e', 'taupe': '#483c32', 'camel': '#D4AF37', 'beige': '#f5f5dc', 'arena': '#f4a460', 'crudo': '#dbd7d2', 'tiza': '#f5f5f5',
    ...
    // Amarillos / Dorados
    'amarillo': '#ffff00', 'amarillo patito': '#fcf655', 'mostaza': '#ffdb58', 'maiz': '#fbec5d', 'limon': '#fff700', 'dorado': METALLIC_GOLD, 'oro': METALLIC_GOLD, 'ambar': '#ffbf00',
