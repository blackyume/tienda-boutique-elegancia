...
export const TOOLS = [
    ...
    { name: 'quote_price', sensitive: false, desc: 'Calcular el PRECIO DE VENTA a partir del costo, cubriendo la comisión de Mercado Pago y el margen deseado. args: {cost(costo de la prenda), packaging?(0), shipping?(0), margin?(50, % de ganancia SOBRE el costo, ej 50 = ganás la mitad del costo), commission?(% comisión MP; NO lo pases, el sistema usa la real o un estimado)}. Devuelve precio sugerido + ganancia neta. Usalo SIEMPRE que el usuario te dé un COSTO o "me costó X" en vez de un precio final.' },
