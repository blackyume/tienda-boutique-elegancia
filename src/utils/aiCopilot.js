...
export const TOOLS = [
    ...
    { name: 'edit_product', sensitive: true, desc: 'EDITAR un producto que YA existe, varios campos de una sola vez. args: {productId, fields:{name?, price?, stock?, category?, colors?(array), sizes?(array), description?}}. Usalo cuando el dueño diga "editá/cambiá el producto X: ..." con uno o más datos. Para las FOTOS está set_photo.' },
    ...
    { name: 'create_product', sensitive: true, desc: 'Crear/publicar producto. args: {name, price, category, sizes:[], colors:[], stock, description, imageUrl?, imageUrls?:[...] (varias fotos del MISMO producto -> galería), visible(bool), cost?(costo de la prenda, SIEMPRE que el dueño lo haya dicho), packagingCost?, shippingCost?(flete por unidad)}. Si calculaste el precio con quote_price, pasá acá los mismos cost/packaging/shipping: sin eso los informes de ganancia salen mal.' },
